            ...
            <div class="row">
              <div class="col-xs-12" style="margin-bottom:10px;">
                <form action="<?php echo url('index'); ?>" method="get" class="form-inline" role="form">
                  <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;" href="<?php echo url('add'); ?>" >添加公告</a>
...
jQuery(function($) {
  ...
  $('.state').change(function() {
    ...
    $.post("<?php echo url('edit'); ?>", {id: id,state: state}).success(function(data) {
