...
<link rel="stylesheet" href = "/static/ace/css/userauth.css">
</head>
                            ...
                            <div class="col-xs-12">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <?php if(in_array($vo['right'],['blue','red'])): ?>
                                                <?php echo $vo['right']=='red'?"<span class='red'>红</span>":"<span class='blue'>蓝</span>"; else: ?>
