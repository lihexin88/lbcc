<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"D:\phpStudy\WWW\lbcc\public/../application/admin\view\currency\add.html";i:1543470272;s:59:"D:\phpStudy\WWW\lbcc\application\admin\view\common\top.html";i:1522230592;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\header.html";i:1522231280;s:63:"D:\phpStudy\WWW\lbcc\application\admin\view\common\sidebar.html";i:1522231178;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\bottom.html";i:1490663526;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="main-content-inner"> 
      ...
      <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li> <a href="<?php echo url('index'); ?>">币种管理</a> </li>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写币名称" value="<?php echo $info['name']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 图标 </label>
                    <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                        <input name="icon" type="text" class="form-control" readonly placeholder="这里图标上传地址" value="<?php echo $info['icon']; ?>">
