<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\lbcc\public/../application/admin\view\admin\add_rule.html";i:1525334438;s:59:"D:\phpStudy\WWW\lbcc\application\admin\view\common\top.html";i:1522230592;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\header.html";i:1522231280;s:63:"D:\phpStudy\WWW\lbcc\application\admin\view\common\sidebar.html";i:1522231178;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
//锁定菜单显示位置
$('a[href="<?php echo url('Admin/Admin/rule'); ?>"]').parents().filter('li').addClass('open active');
//参数赋值
...
$(".form-post").find('button:submit').click(function() {
  $.post("<?php echo url('add_rule'); ?>", $(".form-post").serialize()).success(function(data) {
