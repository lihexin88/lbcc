<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpStudy\WWW\lbcc\public/../application/admin\view\admin\group_auth.html";i:1525334468;s:59:"D:\phpStudy\WWW\lbcc\application\admin\view\common\top.html";i:1522230592;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\header.html";i:1522231280;s:63:"D:\phpStudy\WWW\lbcc\application\admin\view\common\sidebar.html";i:1522231178;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
          ...
          <div class="row">
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form">
                 ...
                 <label class="col-sm-3 control-label no-padding-right"><input name="rules[]" class="auth_rules ace ace-checkbox-2" type="checkbox" value="<?php echo $vo['id']; ?>"><span class="lbl"><?php echo $vo['title']; ?></span></label>
                 <div class="col-sm-9">
                 <?php if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection || $vo['child'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                 <label class="checkbox-inline"><input name="rules[]" class="auth_rules ace ace-checkbox-2" type="checkbox" value="<?php echo $sub['id']; ?>"><span class="lbl"><?php echo $sub['title']; ?></span></label>
                 <?php endforeach; endif; else: echo "" ;endif; ?>
                 </div>
                 </div>
                 <?php endforeach; endif; else: echo "" ;endif; ?>
