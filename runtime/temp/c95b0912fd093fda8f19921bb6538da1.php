<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"D:\phpStudy\WWW\lbcc\public/../application/admin\view\admin\add_user.html";i:1525334446;s:59:"D:\phpStudy\WWW\lbcc\application\admin\view\common\top.html";i:1522230592;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\header.html";i:1522231280;s:63:"D:\phpStudy\WWW\lbcc\application\admin\view\common\sidebar.html";i:1522231178;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\bottom.html";i:1490663526;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="username" type="text" class="col-xs-10 col-sm-5" placeholder="请填写用户名" value="<?php echo $info['username']; ?>" <?php if(isset($info['username'])): ?>readonly<?php endif; ?> />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="description" type="text" class="col-xs-10 col-sm-5" placeholder="说明这个用户的身份" value="<?php echo $info['description']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <div class="radio" style="float:left">
                      <label><input name="group_id" type="radio" class="ace" value="<?php echo $vo['id']; ?>"><span class="lbl"> <?php echo $vo['title']; ?> </span></label>
                    </div>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="radio" style="float:left">
                      <label>
                        <input name="status" type="radio" class="ace" value="1" <?php if($info['status'] == '1'): ?>checked<?php endif; ?> >
                ...
                <div class="clearfix form-actions">
                  ...
                  <input name="user_type" class="hidden" type="text" value="<?php echo $info['user_type']; ?>">
...
//针对用户组的特殊处理
$("input[name=group_id][value=<?php echo $info['user_type']; ?>]").attr("checked", 'checked');
<?php if($info['group_id'] != '5'): ?>
...
$(".form-post").find('button:submit').click(function() {
  $.post("<?php echo url('add_user'); ?>", $(".form-post").serialize()).success(function(data) {
