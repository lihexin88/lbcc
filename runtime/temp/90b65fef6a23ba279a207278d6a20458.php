<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"D:\phpStudy\WWW\lbcc\public/../application/admin\view\method\edit_status.html";i:1543220632;s:59:"D:\phpStudy\WWW\lbcc\application\admin\view\common\top.html";i:1522230592;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\header.html";i:1522231280;s:63:"D:\phpStudy\WWW\lbcc\application\admin\view\common\sidebar.html";i:1522231178;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\bottom.html";i:1490663526;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 是否通过审核 </label>
                  <div class="col-sm-9">
                    <select name="review">
                    <option value="1">审核通过</option>
                    <option value="2"<?php if($status['review'] == '2'): ?>selected<?php endif; ?>>审核未通过</option>
                    </select>
                  </div>
                  </div>
                ...
                <div class="clearfix form-actions">
                  ...
                  <input name="id" class="hidden" type="text" value="<?php echo $status['id']; ?>">
    ...
    <div class="footer-inner">
      <div class="footer-content"> 
        <span class="bigger-120"> 
          <span class="blue bolder"><?php echo config('WEB_SITE_NAME'); ?> </span><?php echo WEB_VERSION; ?>版 
        </span>
      </div>
    </div>
  </div>
...
$(".form-post").find('button:submit').click(function() {
  $.post("<?php echo url('edit_status'); ?>", $(".form-post").serialize()).success(function(data) {
