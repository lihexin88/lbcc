            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="title" type="text" class="col-xs-10 col-sm-5" placeholder="请填写新闻标题" value="<?php echo isset($info['title'])?$info['title']:null; ?>" />
                  </div>
                </div>
                 <div class="form-group">
                  ...
                  <div class="col-sm-10 col-lg-5" style="padding-right: 0px;">
                      <script id="container1" name="content"  text="text/plain"><?php echo $info['content']; ?></script>
                      <script id="container2" name="content"  text="text/plain"><?php echo $info['en_content']; ?></script>
                </div>
                </div>
