<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"D:\phpStudy\WWW\lbcc\public/../application/admin\view\method\index.html";i:1543228157;s:59:"D:\phpStudy\WWW\lbcc\application\admin\view\common\top.html";i:1522230592;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\header.html";i:1522231280;s:63:"D:\phpStudy\WWW\lbcc\application\admin\view\common\sidebar.html";i:1522231178;s:62:"D:\phpStudy\WWW\lbcc\application\admin\view\common\bottom.html";i:1490663526;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                ...
                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>                    
                    ...
                    <tr>
                        ...
                        <?php if($vo['method_type'] == 1): ?>
                        <td>充值</td> 
                        <?php else: ?>
                        <td>提现</td>   
                      	<?php endif; ?>
                      	<td><?php echo $vo['money']; ?></td>
                        <td><?php echo $vo['money']-$vo['service_charge']; ?></td>
                        ...
                        <?php else: ?>
                        <td></td>   
                      	<?php endif; if($vo['review'] == 1): ?>
                        <td>待审核</td>
                        <?php elseif($vo['review'] == 2): ?>
                        <td>审核通过</td>
                        <?php elseif($vo['review'] == 3): ?>
                        <td>审核未通过</td>
                        <?php endif; if($vo['review'] == 1): ?>
                        <td><a class="btn btn-sm btn-success" href="<?php echo url('edit_status',array('id'=>$vo['id'])); ?>" >审核</a></td>
                        <?php else: ?>
                        <td>已审核</td>
                        <?php endif; ?>
                    </tr>
  ...
  function rechargeInfo(obj,id){
    layer.confirm('确定充值|提现吗？',{
        btn: ['确定','关闭'] //按钮
         ...
         $.post("<?php echo url('recharge'); ?>", {id: id}).success(function(data) {
          if (data.code == 0) {
